...
-- Harga Theater Diskon 15%
select id_theater, kelas, harga AS harga_awal, (harga * 0.85) AS harga_diskon, kapasitas from theater;

-- Menampilkan total pemasukan masing-masing theater
select th.id_theater, th.kelas, sum(th.harga) as total_pemasukan 
from transaksi tr 
